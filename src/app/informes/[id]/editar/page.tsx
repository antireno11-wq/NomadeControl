      ...
      <div className="page-stack">
        ...
        <ReportForm
          ...
          defaults={{
            ...
            breakfastMandante: report.breakfastMandante, breakfastNomade: report.breakfastNomade,
            lunchMandante: report.lunchMandante, lunchNomade: report.lunchNomade,
            dinnerMandante: report.dinnerMandante, dinnerNomade: report.dinnerNomade,
            snackSimpleMandante: report.snackSimpleMandante, snackSimpleNomade: report.snackSimpleNomade,
            snackReplacementMandante: report.snackReplacementMandante, snackReplacementNomade: report.snackReplacementNomade,
