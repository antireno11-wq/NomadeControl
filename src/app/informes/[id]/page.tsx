          ...
          <div className="card">
            ...
            <table>
              <tbody>
                ...
                <tr><th>Nivel estanque aguas negras</th><td>{report.blackWaterTankLevelM3 != null ? `${report.blackWaterTankLevelM3} m³` : "—"}{report.blackWaterTankLevelPercent ? ` (${report.blackWaterTankLevelPercent}%)` : ""}</td></tr>
